...
##############################################################################
print("2. Compute XD projection based on fiducial set of parameters but with fNoZ = 0.5.")
param_directory = "./"
w_mag = 0.05/2.
w_cc = 0.025/2.
f_i = [1., 1., 0., 0.25, 0., 0.5, 0.]
...
dz = 0.05
fname = "dNdz-XD-fNoZ50-fiducial-DEEP2.png"
plot_dNdz_selection(cn, w, iXD, redz, area, dz=0.05,\
    ...
    label1="XD fNoZ50", label2="XD fid.", label_total="DEEP2 Total")
